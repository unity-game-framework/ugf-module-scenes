...
## [5.0.0-preview](https://github.com/unity-game-framework/ugf-module-scenes/releases/tag/5.0.0-preview) - 2024-08-14  

### Release Notes

- [Milestone](https://github.com/unity-game-framework/ugf-module-scenes/milestone/25?closed=1)  
    

### Changed

- Update package ([#69](https://github.com/unity-game-framework/ugf-module-scenes/issues/69))  
    - Update dependencies: `com.ugf.editortools` to `9.0.0-preview` version.
    - Update package _Unity_ version to `2023.2`.
    - Update package registry to _UPM Hub_.
    - Change `ISceneModule` and related classes to work with update _Application_ package.

## [4.0.0](https://github.com/unity-game-framework/ugf-module-scenes/releases/tag/4.0.0) - 2023-01-04  

### Release Notes

- [Milestone](https://github.com/unity-game-framework/ugf-module-scenes/milestone/24?closed=1)  
    

### Changed

- Update project ([#67](https://github.com/unity-game-framework/ugf-module-scenes/issues/67))  
    - Update dependencies: `com.ugf.editortools` to `2.15.0` version.
    - Add `SceneModuleAsset` class inspector `Loaders` and `Groups` replacement support.
...
- [Milestone](https://github.com/unity-game-framework/ugf-module-scenes/milestone/21?closed=1)  
    

### Removed

- Remove scene container ([#60](https://github.com/unity-game-framework/ugf-module-scenes/issues/60))  
    - Update dependencies: `com.ugf.application` to `8.3.1` and `com.ugf.editortools` to `2.8.4` version.
    - Change `SceneInstance` class to use `ContainerComponent` class as container component.
    - Remove `SceneContainer` class, use `ContainerComponent ` class instead.
